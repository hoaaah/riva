...
$taTh = \app\models\TaTh::find()->where('(SELECT MAX(tahun) FROM ta_th)')->one();
?>
...
<header class="main-header">
    ...
    <nav class="navbar navbar-static-top" role="navigation">
        ...
        <a href="#" class="sidebar-toggle" data-toggle="offcanvas" role="button">
            ...
            <?php if(isset($taTh)): ?>
            <span class"pull-left"><B><?= strtoupper($taTh->nama_pemda) ?></B></span>
            <?php endif; ?>
        </a>
                ...
                <li class="dropdown tahun notifications-menu">
                    ...
                    <ul class="dropdown-menu">
                        <li>
                            <ul class="menu">
                                <?php
                                    // $existedYears = Yii::$app->db->createCommand(" SELECT a.tahun FROM (SELECT LEFT(bulan, 4) AS tahun FROM lkegiatans) a GROUP BY a.tahun ORDER BY a.tahun ASC")->queryAll();
